...
font_path = Path('fonts/KDL.ttf')
det_model_file_path = Path("Multilingual_PP-OCRv3_det_infer/inference.pdmodel")
rec_model_file_path = Path("korean_PP-OCRv4_rec_infer/inference.pdmodel")
...
while True:
    ...
    print(1, time.time()-s)
    draw_img = processing.draw_ocr_box_txt(image, boxes, txts, scores, drop_score=0.7, font_path=str(font_path))
    print(2, time.time()-s)
